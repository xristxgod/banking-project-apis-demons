...
class ApiTestAdminTransaction(unittest.TestCase):
    ...
    CREATE_TRANSACTION_ADMIN_TOKEN = [
        {"url": "{}/bsc_bep20_usdt/create-transaction".format(__API_URL), "token": "USDT"},
        {"url": "{}/bsc_bep20_usdc/create-transaction".format(__API_URL), "token": "USDC"}
    ]
    SIGN_SEND_TRANSACTION_ADMIN = "{}/bsc/sign-send-transaction".format(__API_URL)
    ...
    def test_send_transaction_admin_native(self):
        ...
        create_transaction = _get_response("POST", ApiTestAdminTransaction.CREATE_TRANSACTION_ADMIN_NATIVE, {
            "outputs": [
                {test_to_address if test_to_address is not None else "0x6fAE511E40F582C50cD487a4999dc857a7bc3527": "0.000001"}
            ],
    ...
    def test_send_transaction_admin_token(self):
        ...
        for dict_url in ApiTestAdminTransaction.CREATE_TRANSACTION_ADMIN_TOKEN:
            create_transaction = _get_response("POST", dict_url["url"], {
                "outputs": [
                    {
                        test_to_address if test_to_address is not None else "0x6fAE511E40F582C50cD487a4999dc857a7bc3527": "0.00001"
                    }
                ],
                "adminAddress": ADMIN_ADDRESS,
                "adminFee": ADMIN_FEE
