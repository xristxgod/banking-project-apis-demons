...
def sign_and_send_transaction(create_tx_hex, max_fee_rate: str, admin_fee: str) -> dict:
    """
    ...
    try:
        ...
        return formatted_tx(tx, max_fee_rate, admin_fee)
    except Exception as e:
...
def formatted_tx(tx, max_fee_rate, admin_fee):
    ...
    recipients.insert(0, {
        ...
        'amountBTC': '%.8f' % admin_fee_without_blockchain_fee,
        'n': -1
    })
