...
async def send_msg_to_kibana(*, msg: str, code=None, tb=None, file_name=None, line=None, url_log=None):
    if url_log is None:
...
async def send_exception_to_kibana(error: Exception, msg: str = None):
    code = error.args[0]
